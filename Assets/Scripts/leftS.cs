...
public class leftS : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if(this.gameObject.transform.parent.CompareTag("spawningBlock") || this.gameObject.transform.parent.CompareTag("block"))
        {
            if (collision.gameObject.tag == "block")
            {
                ...
                if (my_value == target_value)
                {
                    ...
                    if (final == 512)
                    {
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color9;
                    }
                    if (final == 1024)
                    {
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color10;
                    ...
                    if (final == 2048)
                    {
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color11;
                    }
                    if (final == 4096)
                    {
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color12;
                    }
                    if (final == 8192)
                    {
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color13;
                    }
                    if (final == 16384)
                    {
                        this.gameObject.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().fontSize = 140;
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color14;
                    }
                    if (final == 32768)
                    {
                        this.gameObject.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().fontSize = 140;
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color15;
                    }
                    if (final == 65536)
                    {
                        this.gameObject.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().fontSize = 140;
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color16;
                    }
                    if (final > 65536)
                    {
                        this.gameObject.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().fontSize = 100;
                        this.gameObject.transform.parent.GetComponent<SpriteRenderer>().color = Blocks.instance.color17;
                    }
                }
        ...
        //if(this.gameObject.GetComponent<Rigidbody2D>().velocity.magnitude==0 && collision.CompareTag("main"))
        //{
        //    int my_value = int.Parse(this.gameObject.transform.parent.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().text);
        //    int target_value= int.Parse(collision.gameObject.transform.parent.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().text);
        //    if(my_value==target_value)
        //    {
        //        Destroy(collision.transform.gameObject);
        //        this.gameObject.transform.parent.transform.GetChild(0).GetChild(0).GetComponent<TMP_Text>().text = (my_value + target_value).ToString();
